<template>
  <div
    ...
    :style="{
      ...style,
      paddingLeft:
        (Array.isArray(gutterNum) ? gutterNum[0] : Number(gutterNum) / 2) +
        'px',
      paddingRight:
        (Array.isArray(gutterNum) ? gutterNum[0] : Number(gutterNum) / 2) +
        'px',
    ...
    >
      ...
      <template v-else>
        <div
          ...
          :class="[
            `cc-card-header-${size}`,
            { 'cc-card-header-bordered': headerBordered },
          ]"
        >
          <div>
            <div class="cc-card-header-title">
              ...
              <div v-if="tooltip" class="cc-card-header-title-tip">
        ...
        <div
          ...
          :style="{
            ...
            marginLeft:
              -(Array.isArray(gutterNum)
                ? gutterNum[0]
                : Number(gutterNum) / 2) + 'px',
            marginRight:
              -(Array.isArray(gutterNum)
                ? gutterNum[0]
                : Number(gutterNum) / 2) + 'px',
        ...
        <div v-if="actions && actions.length" class="cc-card-action">
          <div
          ...
          >
            <div v-if="action.icon" class="cc-card-action-item-icon">
              <component :is="`ElIcon${action.icon}`" />
            </div>
            <div v-if="action.name" class="cc-card-action-item-name">
              {{ action.name }}
            </div>
          </div>
        </div>
